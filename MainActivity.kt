...
class MainActivity : AppCompatActivity() {
    ...
    private fun navigateToHome() {
        // TODO: Implement navigation to Home activity
    ...
    private fun navigateToInitiatives() {
        // TODO: Implement navigation to Initiatives activity
    ...
    private fun navigateToFriends() {
        // TODO: Implement navigation to Friends activity
    ...
    override fun onOptionsItemSelected(item: android.view.MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_settings -> {
                // Navigate to Settings/Profile activity
                navigateToSettings()
                true
            }
    ...
    private fun navigateToSettings() {
        // TODO: Implement navigation to Settings/Profile activity
